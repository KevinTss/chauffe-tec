      ...
      <div className="flex flex-col lg:grid lg:grid-cols-2 flex-grow py-16 px-8 max-w-screen-xl gap-10">
        <ul className="flex flex-col gap-4 order-2 lg:order-1">
          <motion.li
            ...
            initial={{ opacity: 0, translateX: '-100%' }}
            animate={{ opacity: isLi1InView ? 1 : 0, translateX: isLi1InView ? 0 : '-100%' }}
            transition={{ duration: 0.5 }}
          >
          ...
          <motion.li
            ...
            className="flex flex-col gap-2 bg-white p-4 rounded-lg shadow-sm hover:shadow-md gap-4"
            initial={{ opacity: 0, translateX: '-100%' }}
            animate={{ opacity: isLi2InView ? 1 : 0, translateX: isLi2InView ? 0 : '-100%' }}
            transition={{ duration: 0.5 }}
          >
            <div className="text-blue-600 text-2xl">
              <Icon name="sun" />
          ...
          <motion.li
            ...
            className="flex flex-col gap-2 bg-white p-4 rounded-lg shadow-sm hover:shadow-md gap-4"
            initial={{ opacity: 0, translateX: '-100%' }}
            animate={{ opacity: isLi3InView ? 1 : 0, translateX: isLi3InView ? 0 : '-100%' }}
            transition={{ duration: 0.5 }}
          >
            <div className="text-blue-600 text-2xl">
              <Icon name="droplet" />
          ...
          <motion.li
            ...
            className="flex flex-col gap-2 bg-white p-4 rounded-lg shadow-sm hover:shadow-md gap-4"
            initial={{ opacity: 0, translateX: '-100%' }}
            animate={{ opacity: isLi4InView ? 1 : 0, translateX: isLi4InView ? 0 : '-100%' }}
            transition={{ duration: 0.5 }}
          >
            <div className="text-blue-600 text-2xl">
              <Icon name="home" />
          ...
          <motion.li
            ...
            className="flex flex-col gap-2 bg-white p-4 rounded-lg shadow-sm hover:shadow-md gap-4"
            initial={{ opacity: 0, translateX: '-100%' }}
            animate={{ opacity: isLi5InView ? 1 : 0, translateX: isLi5InView ? 0 : '-100%' }}
            transition={{ duration: 0.5 }}
          >
            <div className="text-blue-600 text-2xl">
              <Icon name="filter" />
